...
const Homepage = () => {
	return (
		<>
				...
				<div className='container mx-auto py-20  transition-all duration-1000 ease-in'>
					<div className='flex justify-center  flex-col md:flex-row'>
						<div className='hero-text w-auto  md:text-left ml-10 mb-1 md:mb-0 '>
							...
							<div className='flex flex-col just-center items-center '>
								<p className='text-gray-500 text-sm mt-4 font-normal font-sans md:w-96 w-screen'>
									With Sahty services, you will receive the best medical
						...
						<div className='flex flex-col  md:w-auto items-center  mb-20  md:mt-22 space-y-10 '>
							<div className='-z-50 absolute top-[400px] md:top-[150px] md:right-[250px] right-10'>
								<img className='w-20' src={arc} alt='arc' />
							</div>
							<div className='relative mt-2 md:top-[180px] md:right-[100px] -z-50'>
			...
			<div className='flex items-center flex-row justify-evenly px-2 py-10 h-22'>
				<div>
					<img className='w-20 h-10 md:h-6' src={who} alt='' />
				</div>
				<div>
					<img className='w-20 h-10 md:h-6' src={hc} alt='' />
				</div>
				<div>
					<img className='w-20 h-10 md:h-6' src={hn} alt='' />
				</div>
				<div>
					<img className='w-20 h-10 md:h-6' src={mbg} alt='' />
				</div>
			</div>
		</>
	);
